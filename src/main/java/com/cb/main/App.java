...
public class App {
    ...
    public static Book getInpBook(Scanner sc) {
        ...
        book.setQty(sc.nextInt()); sc.nextLine();
        return book;
    }
            ...
            switch (mainChoice) {
                case 1:
                    ...
                    while (bookChoice != 0) {
                        ...
                        bookChoice = sc.nextInt(); sc.nextLine();

                        switch (bookChoice) {
                            case 1: bookService.addBook(getInpBook(sc)); break;
                            case 2:
                            ...
                            case 3:
                                ...
                                bookService.removeBook(sc.nextInt()); sc.nextLine();
                                break;
                            case 4: bookService.viewAllBooks(); break;
                            case 5: bookService.viewAvailableBooks(); break;
                            case 6:
                                System.out.print("Enter Book ID :: ");
                                bookService.viewBookById(sc.nextInt()); sc.nextLine();
                                break;
                            case 7:
                                System.out.print("Enter Title :: ");
                ...
                case 2:
                    ...
                    while (userChoice != 0) {
                        ...
                        switch (userChoice) {
                            case 1: userService.addUser(getInpUser(sc)); break;
                            case 2:
                            ...
                            case 3:
                                ...
                                userService.removeUser(sc.nextInt()); sc.nextLine();
                                break;
                            case 4: userService.viewAllUser(); break;
                            case 5:
                                System.out.print("Enter User ID :: ");
                                userService.findUserByID(sc.nextInt()); sc.nextLine();
                                break;
                            case 6:
                ...
                case 3:
                    ...
                    while (trxChoice != 0) {
                        ...
                        System.out.println("0. Back to Main Menu");
                        System.out.print("Enter choice :: ");
                        trxChoice = sc.nextInt(); sc.nextLine();
                        ...
                        switch (trxChoice) {
                            case 1:
                                ...
                                int iu = sc.nextInt();
                                System.out.print("Enter Book ID :: ");
                                int ib = sc.nextInt(); sc.nextLine();
                                trxService.issueBook(ib, iu);
                                break;
                            case 2:
                                System.out.print("Enter Transaction ID :: ");
                                trxService.returnBook(sc.nextInt()); sc.nextLine();
                                break;
                            case 3: trxService.getTransactions(); break;
                            case 4:
                                System.out.print("Enter User ID :: ");
                                trxService.viewTransactionsByUser(sc.nextInt()); sc.nextLine();
                                break;
                            case 5:
                                System.out.print("Enter Book ID :: ");
                                trxService.viewTransactionsByBook(sc.nextInt()); sc.nextLine();
                                break;
                            case 0: break;
                            default: System.out.println("Invalid choice!");
                        }
